...
import com.jgalilee.hadoop.kmeans.KMeansCounters;
import com.jgalilee.java.patterns.resurecting.Iteration;
import com.jgalilee.java.patterns.resurecting.IterativeAlgorithm;

/**
 * K-Means Hadoop algorithm driver following the IterativeAlgorithm interface.
 *
 * @author jgalilee
 */
public class Algorithm implements IterativeAlgorithm {
	...
	/**
	 * Constructs the K-Means algorithm instance from the given configuration.
	 */
